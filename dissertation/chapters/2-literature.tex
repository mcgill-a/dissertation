...
As demonstrated below in Figure \ref{fig:cnn_pooling}, max pooling and average pooling are carried out by:
...
\begin{tabular}[c]{@{}l@{}}Scottish Gaelic (GD)\\ English (EN)\end{tabular} & Bilingual & $57.5$k & OPUS: GNOME v1 (\cite{tiedemann_opus_2012}) \\ \hline
\begin{tabular}[c]{@{}l@{}}Scottish Gaelic (GD)\\ English (EN)\end{tabular} & Bilingual & $36.6$k & OPUS: Ubuntu v14.10 (\cite{tiedemann_opus_2012}) \\ \hline
