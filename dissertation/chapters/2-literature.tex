...
\label{literature}
This chapter will present the background information and approaches for Deep Learning (Chapter 2.1) and discuss the most prevalent techniques and evaluation methods in Machine Translation (Chapter 2.2). It will then investigate data augmentation in Low Resource Machine Translation (Chapter 2.3) and Low-Resource Machine Translation Approaches (Chapter 2.4). Finally, the findings will be concluded in the Literature Review Conclusion (Chapter 2.5).
