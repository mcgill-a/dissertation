...
%A description of the datasets is shown in Table \ref{tab:available-data}, where EN = English, GA = Irish Gaelic, GD = Scottish Gaelic, FR = French, DEU = German, ITA = Italian, and SPA = Spanish.
...
%EN \textrightarrow FR   & 137,500       & Informal      & Udacity Language Translation Dataset (\cite{udacity_data_2020}) \\ \hline
...
%EN \textrightarrow GD   & 1,300         & Informal      & OPUS: Bible (\cite{bible_corpus_2015}) \\ \hline
